                ...
                <Box sx={style}>
                    <Grid container spacing={3}>
                                    ...
                                    <div>
                                        <Typography textAlign="justify" variant="body2" sx={{ mt: 2}}>
                                            {!fullPlot ? props.movie.plot.substring(0, 350) + "..."
                                                : props.movie.plot}
                                            <a style={{textDecoration: "underline", color: "blue", cursor: "pointer"}} onClick={handleReadMore}>Read {fullPlot ? "Less" : "More"}</a>
                                        </Typography>
                                    </div>
                                    ):
                                    <Typography textAlign="justify" variant="body2" sx={{ mt: 2}}>
                        ...
                        <Grid xs={3} item align="center">
                            {!data ? 'Loading...' : <img className="poster" src={data.poster}/>}
                        </Grid>
                    </Grid>
