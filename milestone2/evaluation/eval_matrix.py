...
metrics_export_table(results=standard_results, relevant=relevant, filename='standard_results')
metrics_export_table(results=enhanced_results, relevant=relevant, filename='enhanced_results')

curve(results=standard_results, relevant=relevant, filename="standard_curve")
curve(results=enhanced_results, relevant=relevant, filename="enhanced_curve")