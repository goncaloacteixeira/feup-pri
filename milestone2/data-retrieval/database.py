...
def main():
    ...
    sql_create_movie_personal_table = """CREATE TABLE IF NOT EXISTS movie_personal (
                                            ...
                                            primary key (imdb_title_id, imdb_name_id, role)
                                            );"""
    ...
    df.to_sql('movie_personal', conn, if_exists='append', index=False)
    ...
    ratings_df[ratings_columns].to_sql('movie_ratings', conn, if_exists='append', index=False)
